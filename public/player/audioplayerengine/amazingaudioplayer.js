    ...
    $.fn.amazingaudioplayer = function (options) {
        var PlayerSkin = function (amazingPlayer, container, options, id) {
            ...
            $pause.click(function () {
                if (instance.options.stoponpausebutton) instance.amazingPlayer.stopAudio(); else instance.amazingPlayer.pauseAudio()
            });
        ...
        FlashHTML5Player.prototype = {
            initFlash: function () {
                ...
                window.AmazingSWFObject.embedSWF(this.flashPlayerEngine, objectId, "1", "1", "9.0.0", false, {playerid: this.id}, {
                    wmode: "transparent",
        ...
        this.each(function () {
            ...
            var defaultOptions = {
                ...
                defaultvolume: -1,
                skinsfoldername: "",
                playpauseimage: "/player/audioplayerengine/playpause.png",
                playpauseimagewidth: 28,
                playpauseimageheight: 28,
                showstop: true,
                stopimage: "/player/audioplayerengine/stop.png",
                stopimagewidth: 32,
                stopimageheight: 32,
                showprevnext: true,
                prevnextimage: "/player/audioplayerengine/prevnext.png",
                prevnextimagewidth: 32,
                prevnextimageheight: 32,
                showloop: true,
                loopimage: "/player/audioplayerengine/loop.png",
                loopimagewidth: 32,
                loopimageheight: 32,
                showtitleinbar: true,
                titleinbarwidth: 80,
                ...
                showvolume: true,
                showvolumebar: true,
                volumeimage: "/player/audioplayerengine/volume.png",
                volumeimagewidth: 24,
